...
namespace PokemonTrackerEditor.View.MainWindow {
    class Renderers {
        ...
        public static void ConditionLocation(TreeViewColumn column, CellRenderer cell, ITreeModel model, TreeIter iter) {
        ...
        public static void StoryItemConditionName(TreeViewColumn column, CellRenderer cell, ITreeModel model, TreeIter iter) {
        ...
        public static void StoryItemConditionCollectionCount(TreeViewColumn column, CellRenderer cell, ITreeModel model, TreeIter iter) {
            StoryItemConditionBase storyItemCondition = (StoryItemConditionBase)model.GetValue(iter, 0);
